...
class Report
{
	protected static $_appmagos = '/var/www/html/contabec/module';
    ...
    public static function getConexion() {
		...
		return 'jdbc:postgresql://'.(($domain == '172.30.92.240') ? '172.30.92.228:5434' : '192.168.0.110:5433').'/scont';
	}
